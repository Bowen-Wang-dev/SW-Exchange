export const CURRENT_MILESTONE_VERSION = "v0.17.2";
export const CURRENT_MILESTONE_TITLE = "Portfolio / Asset Display Polish";
export const NEXT_MILESTONE_VERSION = "v0.17.3";
export const NEXT_MILESTONE_TITLE = "Markets Sorting / Favorites Polish";

export const REAL_TIME_SYNC_COPY =
  "Admin-created virtual assets and markets now plug into the same multi-market matching, market-order taker flow, trades, ticker, interactive K-line, searchable portfolio valuation, fee settlement, wallet bucket, ledger, audit, report, status-control, and refreshed trade-flow foundation.";
