        ...
        <div className="grid gap-4 xl:grid-cols-[1.3fr_1fr]">
          ...
          <DataTable
            ...
            rows={[
              ...
              ["Security", <StatusBadge key="security" label="v1.0.2" tone="warning" />, "Security events, email-verification state, and the planned sensitive-action model are now visible in admin"],
