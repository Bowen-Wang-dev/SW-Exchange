      ...
      <div className="grid gap-4 xl:grid-cols-[1fr_1fr]">
        <section className="panel rounded-3xl p-5">
          ...
          <div className="data-divider mt-4 rounded-2xl border border-[var(--border)]">
            {[
              ...
              "Security events now record current login, email-verification, and high-impact admin actions without storing secrets.",
        ...
        <DataTable
          ...
          rows={[
            ...
            ["Security Events", <StatusBadge key="security-events" label="v1.0.2" tone="warning" />, "Read-only security log for login, email verification, and high-impact admin actions"],
            ["Sensitive Actions", <StatusBadge key="security-actions" label="v1.0.2" tone="info" />, "Planned requirement matrix for future re-auth, enforced email, and 2FA checks"],
