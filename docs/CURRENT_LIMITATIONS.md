...
- Chain addresses are not implemented.
- Real fiat redemption is not implemented.

## Trading Scope

- Leverage, futures, and contracts are not implemented.
...
- No placeholder fake implementations should be treated as live product capability.
